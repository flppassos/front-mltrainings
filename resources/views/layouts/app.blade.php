...
<body>
    {{-- Full page --}}
    <div class="flex h-screen antialiased text-gray-900 bg-gray-50">

        {{-- Menu lateral --}}
        <aside class="flex-shrink-0 w-64 h-screen">
                   ...
                   <li>
                      <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-500">
                         ...
                         <span class="ml-3">Menu Lateral</span>
                      </a>
                   </li>
                </ul>
        </aside>
        ...
        <div class="flex-1 h-full bg-white overflow-x-hidden overflow-y-auto">
            {{-- Header no topo --}}
            ...
            <footer>MLtrainings 2023</footer>
        </div>
